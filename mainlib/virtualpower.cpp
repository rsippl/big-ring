...
const std::map<VirtualPowerTrainer, PowerCurve> powerCurves = {
    ...
    { VirtualPowerTrainer::KURT_KINETIC_ROAD_MACHINE, { UnitConverter::SpeedUnit::MilesPerHour, {5.244820, 0, 0.019168} }},
    // Kurt Kinetic Cyclone: P = 6.481090 * mph + 0.020106 * (mph*mph*mph)
    { VirtualPowerTrainer::KURT_KINETIC_CYCLONE, { UnitConverter::SpeedUnit::MilesPerHour, {6.481090, 0, 0.020106} }},
    // Cycleops Fluid 2: P = 8.9788 * MPH + 0.0137 * MPH^2 + 0.0115 * MPH^3
    { VirtualPowerTrainer::CYCLEOPS_FLUID_2, { UnitConverter::SpeedUnit::MilesPerHour, {8.9788, 0.0137, 0.0115} }},
    // ELITE QUBO POWER FLUID f(x) = 4.31746 * kmph -2.59259e-002 * kmph^2 +  9.41799e-003 * kmph^3
    { VirtualPowerTrainer::ELITE_QUBO_POWER_FLUID, { UnitConverter::SpeedUnit::KilometersPerHour, {4.31746, -2.59259e-002, 9.41799e-003} }},
    // Elite Turbo Muin 2013 model P =  0.00791667 v^3 + 0.125 v^2 - 0.16669 v
    { VirtualPowerTrainer::ELITE_TURBO_MUIN_2013, { UnitConverter::SpeedUnit::KilometersPerHour, {- 0.16669, 0.125, 0.00791667} }}
};
